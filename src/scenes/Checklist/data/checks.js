...
export default [
    {
        title: "Subject",
        body: "It's important you choose the right subject for you. Some choose based on what they have enjoyed learning in the past or what best suites their interests while others choose a subject area that could lead into a certain career",
        url: "/",
        imageURL: "/assets/icons/subject.png"
    },
    {
    ...
    {
        title: "Location",
        body: "There are various things to consider when thinking about where to study. Some students stay close to home because of other commitments or to save money on accommodation, while others want to live somewhere new.",
        url: "/",
